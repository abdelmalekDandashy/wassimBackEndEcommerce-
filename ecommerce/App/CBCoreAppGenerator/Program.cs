...
namespace CodeGenerator
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            oCodeBooster.Uploaded_Files_BackEnd_Events.Add
                (
                    new Uploaded_File_BackEnd_Event()
                    {
                        ...
                        UI_METHOD_NAME = "Get_Product_By_Where",
                        Mode = 0
                    }
            ...
            oCodeBooster.Uploaded_Files_BackEnd_Events.Add
                (
                    new Uploaded_File_BackEnd_Event()
                    {
                        ...
                        UI_METHOD_NAME = "Get_Category_By_Where",
                        Mode = 0
                    }
            ...
            //       {
            //           TBL_NAME = "[TBL_PRODUCT]",
            //           UI_METHOD_NAME = "Get_User_By_OWNER_ID",
            //           Mode = 1
            //       }
            //   );
            #endregion
            ...
            // Car
            //----------------------------
            oCodeBooster.APIMethodsSelection.Add("Get_Product_By_OWNER_ID");
