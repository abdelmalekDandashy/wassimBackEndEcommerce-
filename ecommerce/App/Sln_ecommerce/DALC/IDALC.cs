...
Invoice_status Get_Invoice_status_By_INVOICE_STATUS_ID ( Int32? INVOICE_STATUS_ID);
...
Invoice_status Get_Invoice_status_By_INVOICE_STATUS_ID_Adv ( Int32? INVOICE_STATUS_ID);
...
List<Invoice_status> Get_Invoice_status_By_INVOICE_STATUS_ID_List ( List<Int32?> INVOICE_STATUS_ID_LIST);
...
List<Invoice_status> Get_Invoice_status_By_INVOICE_STATUS_ID_List_Adv ( List<Int32?> INVOICE_STATUS_ID_LIST);
...
List<Invoice> Get_Invoice_By_Criteria_InList ( string DESCRIPTION, List<long?> USER_ACCOUNT_ID_LIST, List<Int32?> INVOICE_STATUS_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Invoice> Get_Invoice_By_Where_InList ( string DESCRIPTION, List<long?> USER_ACCOUNT_ID_LIST, List<Int32?> INVOICE_STATUS_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
List<Order_details> Get_Order_details_By_Criteria_InList ( string DESCRIPTION, List<Int32?> PRODUCT_ID_LIST, List<Int32?> INVOICE_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Order_details> Get_Order_details_By_Where_InList ( string DESCRIPTION, List<Int32?> PRODUCT_ID_LIST, List<Int32?> INVOICE_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
List<Invoice> Get_Invoice_By_Criteria_InList_Adv ( string DESCRIPTION, List<long?> USER_ACCOUNT_ID_LIST, List<Int32?> INVOICE_STATUS_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Invoice> Get_Invoice_By_Where_InList_Adv ( string DESCRIPTION, List<long?> USER_ACCOUNT_ID_LIST, List<Int32?> INVOICE_STATUS_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
List<Order_details> Get_Order_details_By_Criteria_InList_Adv ( string DESCRIPTION, List<Int32?> PRODUCT_ID_LIST, List<Int32?> INVOICE_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Order_details> Get_Order_details_By_Where_InList_Adv ( string DESCRIPTION, List<Int32?> PRODUCT_ID_LIST, List<Int32?> INVOICE_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
void Delete_Invoice_status ( Int32? INVOICE_STATUS_ID);
...
Int32? Edit_Invoice ( Int32? INVOICE_ID, long? USER_ACCOUNT_ID, Int32? INVOICE_STATUS_ID, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID, string DESCRIPTION);
...
Int32? Edit_Order_details ( Int32? ORDER_DETAILS_ID, Int32? PRODUCT_ID, decimal PRICE, Int32? QUANTITY, Int32? INVOICE_ID, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID, string DESCRIPTION);
